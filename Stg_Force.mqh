...
class Stg_Force : public Strategy {
 public:
  Stg_Force(StgParams &_params, Trade *_trade = NULL, string _name = "") : Strategy(_params, _trade, _name) {}
  ...
  static Stg_Force *Init(ENUM_TIMEFRAMES _tf = NULL, long _magic_no = NULL, ENUM_LOG_LEVEL _log_level = V_INFO) {
    ...
    Strategy *_strat = new Stg_Force(_stg_params, new Trade(new Chart(_tf, _Symbol)), "Force");
    return _strat;
  }
